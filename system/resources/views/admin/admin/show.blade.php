            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        ...
                        <a href="{{ url("admin/admin/$admin->id") }}/edit" class="btn btn-primary btn-sm float-right"><span class="fa fa-edit"></span> Edit Data</a>
                    </div>
                    <div class="card-body box-profile">
                        ...
                        <a href="{{ url("admin/admin/$admin->id") }}/edit" class="btn btn-primary btn-block"><b><span class="fa fa-edit"></span> Edit Data</b></a>
                    </div>
